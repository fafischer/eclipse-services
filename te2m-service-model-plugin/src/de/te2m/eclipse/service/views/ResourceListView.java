...
import de.te2m.eclipse.service.model.tree.resource.ResourceViewRootNode;
...
/**
 * The Class ResourceListView.
 *
 * @author ffischer
 * @version 1.0
 * @since 1.0
 */
public class ResourceListView extends ViewPart {
	...
	class ViewContentProvider implements IStructuredContentProvider,
		 ...
		 * The invisible root.
		 */
		private ResourceViewRootNode invisibleRoot;
		 ...
		 *            the invisible root
		 */
		public ViewContentProvider(ResourceViewRootNode invisibleRoot) {
			super();
		...
		private void initialize() {
			if (null == invisibleRoot) {
				invisibleRoot = new ResourceViewRootNode("root");
			}
	 ...
	 */
	public static final String ID = "de.te2m.eclipse.service.views.ResourceListView";
	...
	public ResourceListView() {
		...
		invisibleRoot = new ResourceViewRootNode("HiddenRoot");
	...
	private void fillContextMenu(IMenuManager manager) {
		...
		if (viewer.getSelection() instanceof IStructuredSelection) {
			...
			if (object instanceof AttributedTreeParentNode) {
	...
	private void hookContextMenu() {
		...
		menuMgr.addMenuListener(new IMenuListener() {
			public void menuAboutToShow(IMenuManager manager) {
				ResourceListView.this.fillContextMenu(manager);
			}
		});
