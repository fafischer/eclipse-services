...
/**
 * The Class AddReturnValueAction.
 *
 * @author ffischer
 * @version 1.0
 * @since 1.0
 */
public class AddReturnValueAction extends AbstractTreeAction {

	/**
	 * Instantiates a new adds the return value action.
	 *
	 * @param v the v
	 */
	public AddReturnValueAction(TreeViewer v) {
		super();
		myViewer = v;
		setText("Add Return Value");
		setToolTipText("Add a new return value");
	...
	public void run() {
		...
		if (obj instanceof OperationNode) {
			...
			ManageReturnValueWizard wizard = new ManageReturnValueWizard(pn, null);
