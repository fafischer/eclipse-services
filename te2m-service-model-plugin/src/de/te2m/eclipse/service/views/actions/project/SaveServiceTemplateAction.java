/*
* SaveServiceTemplateAction.java
*   
...
import de.te2m.eclipse.service.wizards.service.SaveServiceTemplateWizard;

/**
 * Action SaveServiceTemplateAction.
 * Utilized to save a service as a template.
 * 
 * @author ffischer
 * @version 1.0
 * @since 1.0
 */
public class SaveServiceTemplateAction extends AbstractTreeAction {

	/**
	 * Instantiates a SaveServiceTemplateAction.
	 *
	 * @param v the current TreeViewer
	 */
	public SaveServiceTemplateAction(TreeViewer v) {
		super();
		myViewer = v;
		setText("Save As Template");
		setToolTipText("Save service as template");
	...
	public void run() {
		...
		if (obj instanceof ServiceNode) {
			...
			SaveServiceTemplateWizard wizard = new SaveServiceTemplateWizard(sn);
