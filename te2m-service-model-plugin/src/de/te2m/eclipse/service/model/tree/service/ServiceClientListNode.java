...
/**
 * The Class ConfigurationSetNode.
 *
 * @author ffischer
 * @version 1.0
 * @since 1.0
 */
public class ServiceClientListNode extends TreeParentNode {
	 ...
	 * @param name the name
	 */
	public ServiceClientListNode(String name) {
		super(name);
	}
