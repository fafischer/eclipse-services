...
/**
 * The Class RetValNode.
 *
 * @author ffischer
 * @version 1.0
 * @since 1.0
 */
public class RetValNode extends SimpleParameterNode
{   
   

    /**
     * Instantiates a new ret val node.
     *
     * @param ci the ci
     */
    public RetValNode(ParameterInfo ci) {
	super(ci);
    ...
    public String getImageDescriptor()
    {
        ...
        return ISharedImages.IMG_TOOL_BACK;
    }
